...
contract FoxiverseLand is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
  using Counters for Counters.Counter;

  Counters.Counter private _tokenIdCounter;

  constructor() ERC721("Foxiverse lands", "FXLND") {}
  ...
  function mintLand(string memory uri) public payable returns (uint) {
  ...
  function bulkMint(uint256 count, string[] memory jsonUri) public{
